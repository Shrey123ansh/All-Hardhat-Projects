...
contract Staking {
    ...
    function getPositionIdsForId(uint positionId) external view returns(Position memory){
    ...
    function closePosition(uint positionId) external{
        ...
        uint numberDays = calculateInterestDays(positions[positionId].createdDate);
    ...
    function calculateInterestDays(uint createdDate) public view returns(uint){
    ...
    modifier onlyOwner{
            require(owner == msg.sender,"Only onwer may call this function");
            _;
    }
